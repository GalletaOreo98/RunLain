...
public class GameScreen extends JPanel implements Runnable, KeyListener {
    ...
    public void paint(Graphics g) {
        //g.setColor(Color.decode("#fa1be8"));
        //g.fillRect(0, 0, getWidth(), getHeight());
        Graphics2D g2d = (Graphics2D) g;
        GradientPaint verticalGradient = new GradientPaint(0, 0, Color.decode("#b01fac"), 0, getHeight(), Color.decode("#23255e"));
        ...
        switch (gameState) {
            ...
            case GAME_OVER_STATE:
                ...
                if (gameState == GAME_OVER_STATE) {
                    g.drawImage(gameOverButtonImage, 180, 30, null);
                    g.drawImage(replayButtonImage, 278, 65, null);
